                ...
                <div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
                    ...
                    <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                        <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg"><br>
                            <div v-bind:var="show = true"></div>
                            <div v-for="usershop in usershops">
                                <div v-if="usershop.shop_id === shop.id">

                                    <button class="form-check" @click="deleteFavory(usershop.id)" v-bind:var="show = false">
                            ...
                            <button class="form-check" @click="submitFavory(shop.id)">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 473.487 473.487" class="h-6 w-6 fill-current text-grey-darker" v-show="show">
